...
{
    public partial class GuidelinesCoordinator : System.Web.UI.Page
    {
        ...
        {
            string[] filePaths = Directory.GetFiles(Server.MapPath("~/Guidelines/"));
        ...
        protected void Button_upload_Click(object sender, EventArgs e)
        {
            ...
            {
                FileUpload1.SaveAs(Server.MapPath("~/Guidelines/") + FileUpload1.FileName);
                BindGrid();
            }
