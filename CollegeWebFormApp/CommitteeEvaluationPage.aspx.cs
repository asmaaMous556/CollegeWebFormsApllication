...
{
    public partial class CommitteeEvaluationPage : System.Web.UI.Page
    {
        ...
        private void fillCommitteToText()
        {
            var idForSupervisor = Convert.ToInt32(Session["SupervisorId"]);
            SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["CollegeModel"].ConnectionString);
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            comman.CommandText = $" insert into CommitteEvaluations (state,comment,StudentId,SupervisorId,CId)values(@state,@comment,@StudentId,@SupervisorId,@CId) ";
