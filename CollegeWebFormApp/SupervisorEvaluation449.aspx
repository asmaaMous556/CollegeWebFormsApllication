<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SupervisorEvaluation449.aspx.cs" Inherits="CollegeWebFormApp.SupervisorEvaluation" %>
...
<body style="height: 2750px">
    <form id="form1" runat="server">
        <div class="auto-style1">
            <h3>
                <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Project 2 (COIT 499)Evaluation form (for a Supervisor)
            </h3>
            <p>
            ...
            <h3>
                <br />
                Supervisor :<asp:TextBox ID="TextBox_name" runat="server" CssClass="auto-style90" Width="129px"></asp:TextBox>
            </h3>
            <h3>
                <br />
                <br />
                Students :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:DropDownList ID="DropDownList_students" runat="server">
                </asp:DropDownList>
                <br />
                <br />
            </h3>
...
So(I): An Ability to effectively integrated IT-based solution into the user environment.<br />
            ...
            <table class="auto-style9">
                <tr>
                    <td class="auto-style20">Knowledge of the integration technologies based on project&#39;s context</td>
                    <td class="auto-style74">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 5</td>
                    <td class="auto-style17">
      ...
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Student outcome(n)<br />
            <br />
            SO(n): An ability to assist in the creation of an effective project plan.<br />
            <table class="auto-style9">
                <tr>
            ...
            <br />
            Remarks(please attach additional sheet if necessary):<br />
            <br />
        </div>
    </form>
</body>
